...
open class ML_ScrollSegmentView: UIView {
    
    // 1. 实现颜色填充效果
    
    
    /// 所有的title设置(style setting)
    open var segmentStyle: ML_SegmentStyle
    ...
    //MARK:- life cycle
    public init(frame: CGRect, segmentStyle: ML_SegmentStyle, titles: [String]) {
...
//MARK: - public helper
extension ML_ScrollSegmentView {
